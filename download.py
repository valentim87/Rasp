...
m = imaplib.IMAP4_SSL("64.233.190.109")
m.login(user,pwd)
...
print "Verificamos a integridade dos arquivos do protocolo SMTP de 10 enviados: " , len(finalSMTP) ," Chegaram integros."
...
print "Verificamos a integridade dos arquivos do protocolo FTP de 10 enviados: ", len(finalFTP) ," Chegaram integros."
